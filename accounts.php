         ...
         <div class="container">   
            <div class="col-lg-3" style="text-align: center; background-color: #D5DBDB; height:700px;">
                ...
                <div class="menu-div">
                    ...
                    <input type="button" class="report" value="Accounts" disabled="true" style="background-color:#B2BABB;">
            ...
            <div class="col-lg-9 content" style="height: 700px;">
                ...
                <div class="col-lg-8 container" style="text-align: center;"> 
                    <img src="images/download.png" class="img-responsive" style="height: 150px; width: 150px; margin-left: 170px;margin-top: 10px;">
                    <br>
                    <br>
